...
class TestSourceLocation:
    ...
    def test_line_validation(self):
        ...
        with pytest.raises(ValidationError):
            SourceLocation(
                file_path="test.py", start_line=20, end_line=10
            )
    ...
    def test_contains_different_files(self):
        ...
        loc2 = SourceLocation(
            file_path="file2.py", start_line=15, end_line=18
        )
    ...
    def test_overlaps(self):
        ...
        loc2 = SourceLocation(
            file_path="test.py", start_line=15, end_line=25
        )
        loc3 = SourceLocation(
            file_path="test.py", start_line=30, end_line=40
        )
